      ...
      <section className=" block m-auto w-[482px] h-max bg-[#3B3B3B] rounded-4xl justify-items-center p-6">
        <div className="flex flex-col w-full px-12 justify-center">
          ...
          <form>
            ...
            <div className="text-white text-sm mb-4 flex items-start rounded-xl">
              <input className="mt-1" type="checkbox" required />
              <p className="">
                By pressing agree and continue below, I agree to (our app's name
                goes here) terms and conditions of service and privacy policy
              </p>
            </div>
